...
i_vehicleLicense, i_CellphoneNumber, i_currentPowerInPowerSource, i_Wheels, i_VehicleDetails); break;
        ...
        private static void createATruck(Garage io_Garage, string i_Owner, string i_CarModule, string i_vehicleLicense, string i_CellphoneNumber, float i_currentPowerInPowerSource, List<Wheel> i_Wheels, List<string> i_VehicleDetails)
        {
            ...
            //add engine valume
            Truck truckToAdd = new Truck(i_CarModule, i_vehicleLicense, isToxic, maxCarryWeight, i_Wheels, fuelTank);
        ...
        private static void createAnElectricMotorCycle(Garage io_Garage, string i_Owner, string i_i_CarModule, string i_vehicleLicense,
            string i_CellphoneNumber, float i_currentPowerInPowerSource, List<Wheel> i_i_Wheels, List<string> i_VehicleDetails)
        {
            ...
            Motorcycle motorcycleToAdd = new Motorcycle(carModule, i_vehicleLicense, motorcycleLicenceType, engineVolume, i_i_Wheels, battery);
        ...
        private static void createARegularMotorCycle(Garage io_Garage, string i_Owner, string i_CarModule, string i_vehicleLicense, string i_CellphoneNumber, float i_currentPowerInPowerSource, List<Wheel> i_Wheels, List<string> i_VehicleDetails)
        {
            ...
            int engineVolume = int.Parse(i_VehicleDetails[1]);
            //add engine valume
            Motorcycle motorcycleToAdd = new Motorcycle(i_CarModule, i_vehicleLicense, motorcycleLicenceType, engineVolume, i_Wheels, fuelTank);
        ...
        private static void createARegularCar(Garage io_Garage, string i_Owner, string i_CarModule,
            string i_vehicleLicense, string i_CellphoneNumber, float i_currentPowerInPowerSource, List<Wheel> i_Wheels, List<string> i_VehicleDetails)
        {
            ...
            Car carToAdd = new Car(i_CarModule, i_vehicleLicense, color, numberOfDoors, i_Wheels, battery);
        ...
        private static void createAElectricCar(Garage io_Garage, string i_Owner, string i_CarModule,
            string i_vehicleLicense, string i_CellphoneNumber, float i_currentPowerInPowerSource, List<Wheel> i_Wheels, List<string> i_VehicleDetails)
        {
            ...
            string color = i_VehicleDetails[0];
            int numberOfDoors = int.Parse(i_VehicleDetails[1]);
            Car carToAdd = new Car(i_CarModule, i_vehicleLicense, color, numberOfDoors, i_Wheels, fuelTank);
